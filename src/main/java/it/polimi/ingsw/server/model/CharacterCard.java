...
/**
 * This class represents the CharacterCard, which can be played only if the Game is in expertMode.
 * Each one has a cost, a description which tells the player what he can do additionally if he chooses the card, and a name.
 */
